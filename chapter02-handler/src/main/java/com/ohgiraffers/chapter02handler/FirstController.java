...
public class FirstController {
    ...
    @PostMapping("body")
    public void bodyTest(@RequestBody String body,@RequestHeader("content-type") String contentType, @CookieValue(value = "JESSIONID", required = false) String sessionID) throws UnsupportedEncodingException {
